  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('public/admin_asset/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('public/admin_asset/plugins/summernote/summernote-bs4.min.css')}}">
  <!--Sweetalert2-->
