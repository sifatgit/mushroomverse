    ...
    setInterval(function() {
      ...
      $.ajax({
        ...
        success: (response) => { 
          ...
          const sound = new Audio("{{ asset('public/admin_asset/sounds/message-notification-190034.mp3')}}"); // Change sound dynamically
              sound.play();
        ...
        setTimeout(function(){
            ...
            $.ajax({
                ...
                success: function(response){
                  ...
                  if(total_messages > 0){
                    const sound2 = new Audio("{{ asset('public/admin_asset/sounds/message-notification-190034.mp3')}}"); // Change sound dynamically
                    sound2.play();
                    //$('#last_message_id').val(response.last_message_id);
                            Swal.fire({
                              title: 'Messages!',
