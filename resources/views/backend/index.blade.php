...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('/admin_asset/dist/img/Mushroomverse_logo.png')}}" alt="AdminLTELogo" height="150" width="150">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{URL::to('/')}}" class="brand-link">
      <img src="{{asset('/admin_asset/dist/img/Mushroomverse_logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('admin_asset/dist/img/blank_profile.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
