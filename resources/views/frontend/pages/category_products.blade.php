...
<form id="sortForm" action="{{ route('products.sort') }}" method="GET">
    ...
    <select id="sortOption" name="sort_option" class="selectpicker show-tick form-control" onchange="product_sort_filter()">
        ...
        <option value="low_price" {{ $sort_option == 'low_price' ? 'selected' : '' }}>Low Price → High Price</option>
                                ...
                                <p id="product-head" >Showing <span style="font-weight: bold;">{{$category->name}}</span></p>
                            </div>
                        ...
                        <div class="product-categorie-box">
                            <div class="tab-content">
                                ...
                                <select class="btn weight-dropdown" id="#weight-dropdown" name="measurement_id" required>
				...
				<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    ...
                    @php $minPrice = App\Models\Product::orderBy('price', 'asc')->first(); @endphp
                    @php $maxPrice = App\Models\Product::orderBy('price', 'desc')->first(); @endphp
                ...
                <form id="price-filter-form" action="{{ route('product.price_filter') }}" method="GET">
                    ...
                    <p>
                        ...
                        <input type="hidden" name="min_price" id="min_price" value="{{ $minPrice->price ?? 0 }}">
                        <input type="hidden" name="max_price" id="max_price" value="{{ $maxPrice->price ?? 10000}}">
